...
const Whiteboard = ({ aspectRatio = 4 / 3 }) => {
  ...
  function uploadVideo(e) {
    ...
    var url_mp4 = URL.createObjectURL(file); //'http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4';
    ...
    // var fab_video = fabric.Image(videoE, {left: 0,   top: 0});
...
function uploadAudio(e) {
    ...
    var url = URL.createObjectURL(file); //'http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4';
    var audiourl = getAudioElement(url);

    // var audio = new fabric.Rect(audiourl, { 
    //   originX: 'center',
    //   originY: 'center', top: 75, left: 75 
    // })

    HTMLCanvasElement

    var audio = new fabric.Image(audiourl, {
      left: 200,
      top: 300,
      angle: 0,
      originX: 'center',
    ...
    <div ref={whiteboardRef} className={styles.whiteboard}>
      <div className={styles.toolbar}>
        ...
        <div className={styles.uploadDropdown}>
          ...
          <input ref={uploadVideoRef} accept="video/*" type="file" onChange={uploadVideo} />
          <input ref={uploadAudioRef} accept="audio/*" type="file" onChange={uploadAudio} />
          ...
          <div className={styles.dropdownContent}>
            ...
            <span onClick={() => uploadVideoRef.current.click()}>Video</span>
            <span onClick={() => uploadAudioRef.current.click()}>Audio</span>
          </div>
        </div>
